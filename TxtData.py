...
path = r'D:\Санкт Петербург жизнь и работа\Техническая литература\словарик.txt'
...
words.to_csv('D:\Санкт Петербург жизнь и работа\Техническая литература\словарик.csv')
print(words)